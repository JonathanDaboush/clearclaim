...
class BillingService:
    ...
    def record_payment(self, user_id: str, amount: float, method: str) -> Dict[str, Any]:
        """Record a payment transaction. Logs and notifies."""
        ...
        return {"status": "Payment recorded", "payment_id": payment_id}
